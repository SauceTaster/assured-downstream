...
def dependabot_config() -> str:
    return """# Generated by SauceTotal. Review before merging upstream.
version: 2
updates:
...
def dependency_review_workflow(
    *,
    ...
    return f"""# Generated by SauceTotal. Review before merging upstream.
name: SauceTotal Dependency Review
...
def evidence_readme(overlay: dict[str, Any]) -> str:
    ...
    return f"""# SauceTotal Evidence

This directory is reserved for SauceTotal evidence artifacts.
